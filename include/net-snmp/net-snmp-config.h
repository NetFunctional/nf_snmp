...
#define NETSNMP_CONFIGURE_OPTIONS "'--disable-shared' '--target=arm-apple-darwin9' '--host=arm-apple-darwin9' '--with-cc=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc-4.2' '--with-linkcc=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc-4.2' '--with-ar=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/ar' '--with-endianness=little' '--prefix=/Users/Mac/netsnmp_sim' '--exec-prefix=/Users/Mac/netsnmp_sim-exec' '--disable-agent' 'host_alias=arm-apple-darwin9' 'target_alias=arm-apple-darwin9' 'CC=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc-4.2' 'CFLAGS=-O2 -Wno-unused-label -arch i386 -DPJ_SDK_NAME="iPhoneSimulator4.2.sdk"  -isysroot /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator4.2.sdk' 'LDFLAGS=-O2  -Bstatic -isysroot /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator4.2.sdk -framework Foundation' 'CPP=/Developer/Platforms/iPhoneSimulator.platform/Developer/usr/bin/gcc-4.2  -E -isysroot /Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator4.2.sdk'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs:/Users/Mac/netsnmp_cross_compile/netsnmp_sim/share/snmp/mibs"
...
#define PACKAGE_STRING "Net-SNMP 5.6.1.1"
#endif
...
#define SNMPLIBPATH "/Users/Mac/netsnmp_sim-exec/lib/snmp"
#define SNMPSHAREPATH "/Users/Mac/netsnmp_sim/share/snmp"
#define SNMPCONFPATH "/Users/Mac/netsnmp_sim/etc/snmp"
#define SNMPDLMODPATH "/Users/Mac/netsnmp_sim-exec/lib/snmp/dlmod"
